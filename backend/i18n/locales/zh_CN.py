...
""",
    ...
    "export": {
        ...
        "html": {
            ...
            "last_message_text": "最后消息内容",
            "message_count": "消息总数",
            "unread_count": "未读数",
            "is_archived": "已归档",
            "export_warning": "导出告警",
            "chats_search_placeholder": "搜索会话名、用户名或 ID",
            "chats_sort_hint": "点击表头排序",
            "chats_no_results": "没有符合条件的会话",
            "chats_total": "共 {total} 个会话",
            "chats_filtered_count": "匹配 {shown} / {total}",
            "status_ok": "正常",
            "status_left": "已退出",
            "status_readonly": "仅可读",
            "status_blocked": "被封禁",
